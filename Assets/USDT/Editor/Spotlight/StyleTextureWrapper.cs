    ...
    public partial class SpotlightWindow {
        ...
        private class StyleTextureWrapper {
            ...
            private struct TextureIconContainer {
                ...
                public TextureIconContainer(IconType type) {
                    ...
                    switch (type) {
                        ...
                        case IconType.Tools:
                            this.selected = StyleTextureWrapper.LoadCustomIcon("Spotlight_Tools_Selected.psd");
                            this.unSelected = StyleTextureWrapper.LoadCustomIcon("Spotlight_Tools.psd");
                            break;
                        ...
                        case IconType.Scene:
                            this.selected = StyleTextureWrapper.LoadCustomIcon("Spotlight_Unity_Selected.psd");
                            this.unSelected = StyleTextureWrapper.LoadCustomIcon("Spotlight_Unity.psd");
                            break;

                        case IconType.Unknown:
                        default:
                            this.selected = StyleTextureWrapper.LoadCustomIcon("Spotlight_Unknown_Selected.psd");
                            this.unSelected = StyleTextureWrapper.LoadCustomIcon("Spotlight_Unknown.psd");
                            break;
                    }
            ...
            public IconType GetIconTypeFromString(string s) {
                ...
                else if (s.StartsWith("Tools")) {
                    return IconType.Tools;
                }
            ...
            private static Texture2D MakeTex(int width, int height, Color32 textureColor, RectOffset border, Color32 bordercolor) {
                ...
                for (int i = 0; i < pix.Length; i++) {
                    ...
                    if (i < (border.bottom * width)) {
                    ...
                    else if (i >= width * (height - border.top)) {
                        pix[i] = bordercolor;
                    }
                    else {
                        ...
                        else if ((i % width) >= (width - border.right)) {
                            pix[i] = bordercolor;
                        }
                        else {
                            pix[i] = textureColor;
