...
namespace USDT.CustomEditor.ScriptTemplates {
    public static class TemplatesCreator
    {
        // ecs
        static readonly string ComponentTemplate = "c6ae1b97fcfea5f44b65dd7c16df1747";
        static readonly string AuthoringTemplate = "f4abf72bf1e3d8e4bb444cbed495b9f3";
        static readonly string SystemTemplate = "f3ae3995ab21bf54cae8cc6e6f99f8a3";

        [MenuItem("Assets/Create/ScriptTemplates/ECS/Component")]
        private static void NewComponent()
        {
        ...
        [MenuItem("Assets/Create/ScriptTemplates/ECS/Authoring")]
        private static void NewAuthoring()
        {
        ...
        [MenuItem("Assets/Create/ScriptTemplates/ECS/System")]
