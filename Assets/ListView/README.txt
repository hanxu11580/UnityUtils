...
1. A GameObject with a component that extends ListViewController
2. At least one template prefab with a component that implements IListViewItem
3. A data source composed of IListViewData objects
