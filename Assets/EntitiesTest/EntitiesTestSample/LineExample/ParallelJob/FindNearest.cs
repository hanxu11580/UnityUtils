...
namespace EntitiesTest.LineExample.ParallelJob {
    ...
    public class FindNearest : MonoBehaviour
    {
        ...
        public void Start()
        {
            SingleThreadedJob.Spawner spawner = GetComponent<SingleThreadedJob.Spawner>();
        ...
        public void Update()
        {
            ...
            {
                TargetPositions[i] = SingleThreadedJob.Spawner.TargetTransforms[i].localPosition;
            }

            for (int i = 0; i < SeekerPositions.Length; i++)
            {
                SeekerPositions[i] = SingleThreadedJob.Spawner.SeekerTransforms[i].localPosition;
            }
